...
sysManage.menuManage.main.initMainPanel = function(){  
	...
	//  					text : atom.constant.viewStuBtnText,
	//  					iconCls : 'btnIconEdit',
	//  					tooltip: atom.constant.viewStuBtnTip,
				handler : sysManage.menuManage.main.view
			},{
				bizCode : "EDIT",
				text:'编辑',
	...
	//  					tooltip: atom.constant.addStuBtnTip,        //鼠标悬停在按钮上时的提示信息
				handler : sysManage.menuManage.main.test
			}]
		},
...
sysManage.menuManage.main.view = function(){
	//菜单面板
	...
	if (rec) {
		...
		//调用编辑二级页面
		sysManage.menuManage.entry.showWin("查看");
	}
}
...
//	//定义命名空间
//	var className = sysManage.menuManage.panel.menuGridPnl;
//	//判断菜单信息是否被选中
...
sysManage.menuManage.main.test = function(){
	alert('test');
}
