...
public interface EquipmentFieldService extends BaseService<EquipmentField> {
	 ...
	 * @author Chen Cai
	 * @throws @date
	 *             2018年6月5日 上午11:54:19
	 * @version V1.0
	 */
	void insertField(String code, String name, int length, String fileType, long typeId, String allowBlank,
			String fieldContent);
}
